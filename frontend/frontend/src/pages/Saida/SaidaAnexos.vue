...
const state = reactive<{ entrada: Entrada, filesUploaded: Arquivo[], fileDelete: any }>({ entrada: new Entrada(), filesUploaded: [], fileDelete: null });
...
const props = defineProps({
  	entradaId: {type: Number, required: true},
})
...
async function getAnexos() {
    const entrada = await serviceFactory.createEntradaService().findOne(props.entradaId);
...
async function uploadFile(){
	...
	await serviceFactory.createEntradaService().insertFile(arquivosUploaded, props.entradaId)
	file.value = null
				...
				<template v-slot:body="props">
					<q-tr :props="props">
                        ...
                        <q-td key="actions" :props="props">
                            <q-btn round flat icon="o_delete" @click="alertaDeletar(props.row)" disabled></q-btn>
                        </q-td>
					</q-tr>
				</template>
			</q-table>
